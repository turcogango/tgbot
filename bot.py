...
Webhook ile Conflict hatası önlenmiş
"""
...
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # Railway'de HTTPS endpoint
...
if not BOT_TOKEN or not WEBHOOK_URL:
    raise RuntimeError("BOT_TOKEN ve WEBHOOK_URL Railway Variables içinde olmalı!")
